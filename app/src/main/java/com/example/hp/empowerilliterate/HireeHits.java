...
public class HireeHits extends ListActivity {
    ArrayList<String> result= new ArrayList<String>();
    private SQLiteDatabase newDB;
    int i=0;
    String phn,hirer=null,hiree=null,date=null,content;
    ...
    private void openAndQueryDatabase() {
        ...
        Cursor c=newDB.rawQuery("select *from search where phn='"+phn+"'",null);
        if(c!=null)
        {
            if(c.moveToFirst())
            {
